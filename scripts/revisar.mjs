...
const CLAVE = [
  ...
  'periodosDe', 'estructuraDe', 'comoSeJuega', 'recortarPeriodos', 'pintarDuracion', 'sugerirComoSeJuega', 'aplicarTema', 'temaDe', 'pintarResumen'
]
...
*/
const UNO_A_LA_VEZ = {
  // Las cinco hojas se pintan dentro de #hoja-registro, que tiene un solo
  // ocupante: partido, entrenamiento, mis datos, calendario o mascota.
  'titulo-hoja': 5,
  cancelar: 5,
  sensacion: 2,
